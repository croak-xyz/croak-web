...
const WalletData: any = ({...props }: any) => {
    ...
    return (
      <div 
        style={{
          ...
          <Title>Calculate MAU price</Title>
          ...
          >
              <WhiteWrapper>
                  <div style={{borderBottom: '1px solid rgba(237, 237, 255, 1)', paddingBottom: 20}}>
                    <Text>How many MAU do you expect?</Text>
              ...
              <div style={{display: 'flex', width: '100%', flexDirection: 'column'}}>
                  <WhiteWrapper>
                      <Text>Paid Plan</Text>
                      <Purple style={{marginTop: 38, marginBottom: 38}}>${price}/mo</Purple>
                  </WhiteWrapper>
